...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(Custom-mode-default ((t (:inherit autoface-default :background "#0b181f" :foreground "#c5c5c5"))) t)
 '(autoface-default ((t (:inherit default))))
 '(text-mode-default ((t (:inherit default :stipple nil :foreground "#e0e0e0" :strike-through nil :underline nil :slant normal :weight normal :height 130 :width normal :family "Lucida Grande")))))
